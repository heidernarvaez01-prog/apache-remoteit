  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        blogSoporte: resolve(__dirname, 'HTML/blog-soporte-ti.html'),
        blogAutomatizacion: resolve(__dirname, 'HTML/blog-automatizacion.html'),
        blogCumplimiento: resolve(__dirname, 'HTML/blog-iso-27001-pymes.html'),
        blogMedida: resolve(__dirname, 'HTML/blog-software-a-la-medida.html'),
